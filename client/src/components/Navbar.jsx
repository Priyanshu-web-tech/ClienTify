              ...
              <div className="px-5 pb-6 pt-5">
                ...
                <div className="mt-2 flex">
                  <nav className="flex flex-col space-y-2">
                    ...
                    <Link
                      to="/"
                      className="hover:text-red transition duration-300 block"
                    >
                      Home
                    </Link>
                    {currentUser ? (
                      <div className="flex flex-col space-y-2">
                        ...
                        <button
                          onClick={handleSignOut}
                          className="hover:text-red transition duration-300 block text-left"
                        >
                          Sign Out
                        </button>
                      </div>
                      ...
                      <Link to="/sign-in" className="block">
                        <button className="hover:text-red transition duration-300 block text-left">
                          Sign in
                        </button>
                      </Link>
                    )}
